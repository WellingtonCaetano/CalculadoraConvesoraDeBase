...
public class TelaCalculadora extends javax.swing.JFrame {
    ...
    private void formWindowClosing(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowClosing
        ...
        // TODO add your handling code here:
        int resposta = JOptionPane.showConfirmDialog(null, "Deseja Realmente fechar a calculadora meu caro?",
                "SóTestando", JOptionPane.YES_NO_OPTION);
        if (resposta == JOptionPane.YES_OPTION) {
            this.dispose();
        } else {
            TelaCalculadora tela = new TelaCalculadora();
            tela.setVisible(true);
            String text = jTextFieldSaida.getText();
            tela.jTextFieldSaida.setText(text);
        }
